...
public class CarInventory1000Cars {
    public static void main(String[] args) {
      ...
      /*  for(String eachCar : cars){
        ...
        System.out.println("Count of Chevrolet is: " + cntChev);
        System.out.println("Count of Civic is: " + cntCivic);
        System.out.println();*/
...
int countCivic=0;
        ...
        //task
        //print all location of Civic in the array

        for (int i=0;i<cars.length;i++){

            if (cars[i].contains("Civic")){
                System.out.println("Location of -index of- civic is: "+i);
            }
        }
